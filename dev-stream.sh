...
kubectl exec -it $pod -- ffmpeg -stream_loop -1 -re -i https://storage.googleapis.com/lp_testharness_assets/official_test_source_2s_keys_24pfs.mp4 -c:v copy -c:a copy -f flv rtmp://localhost/live/bbb
